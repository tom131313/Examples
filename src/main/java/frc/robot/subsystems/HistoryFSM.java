...
public class HistoryFSM extends SubsystemBase {
  ...
  private Time m_nextTime = Milliseconds.of(m_endOfTime);
  Time m_changeColorPeriod = Seconds.of(2.0); // display color for this long
  Time m_colorLockoutPeriod = Seconds.of(20.0); // try not to reuse a color for this long
